...
<div class="row">
  ...
  <fieldset>  
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type="date" class="form-control" id="inputEmail" placeholder="Date">
      </div>
    </div>
    <div class="form-group">
      <label for="adultTicket" class="col-md-2 control-label">Adult</label>
      <div class="col-md-10">
        <input type="number" class="form-control" id="adultTicket" placeholder="number">
      </div>
    </div>
    <div class="form-group">
      <label for="childTicket" class="col-md-2 control-label">Child</label>
      <div class="col-md-10">
        <input type="number" class="form-control" id="childTicket" placeholder="number">
      </div>
    </div>
